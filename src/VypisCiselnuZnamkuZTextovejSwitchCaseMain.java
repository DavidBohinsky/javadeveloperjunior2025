...
public class VypisCiselnuZnamkuZTextovejSwitchCaseMain {
    ...
    public static void main(String[] args) {
        ...
        label:
        while (true) {
            System.out.println("Zadaj slovnú známku (výborný, chválitebný, dobrý, dostatočný, nedostatočný). Zadaj koniec");
